...
// // Components
// export const BountyCard: React.FC<{ bounty: Bounty; onSolve: (bountyId: string) => void; onAcceptSolution: (bountyId: string, solutionId: string) => void }> = ({ bounty, onSolve, onAcceptSolution }) => {
